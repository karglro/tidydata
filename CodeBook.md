...
The following steps were performed on the original data (see run_analysis.R)
...
subject				subject id (as given in the original data) labeled 1,2,3,...  
activity			name of activity (SITTING, WALKING, STANDING, etc.)
tBodyAcc-mean()-X		mean of values of this measurement by given subject and activity (as for all the variables below)
tBodyAcc-mean()-Y		
tBodyAcc-mean()-Z
tBodyAcc-std()-X
tBodyAcc-std()-Y
...
#### Note
Refer to the original data set as to the normalization of orignal measurements